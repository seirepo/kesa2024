...
Filter the outliers using interquartile range (IQR): filter out data points that are further than 1.5 * IQR away from Q1 or Q3 of the data in the current window. If the window doesn't fit (in the beginning/end), just keep the data as is.
```{r}
...
write.csv(all_data_1, "data/all_data_merged_f30.csv", row.names = FALSE)
write.csv(all_data_2, "data/all_data_merged_f60.csv", row.names = FALSE)
write.csv(all_data_3, "data/all_data_merged_f240.csv", row.names = FALSE)
```
