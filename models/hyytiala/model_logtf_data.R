...
path <- "data/all_data_transformed_merged.csv"
...
fit_path <- "/scratch/dongelr1/susannar/kesa2024/fitted_models_log.RData"
score_df_path <- "/scratch/dongelr1/susannar/kesa2024/score_df_log.RData"

# fit_path <- "/scratch/dongelr1/susannar/kesa2024/fitted_models_transformed_f30.RData"
# score_df_path <- "/scratch/dongelr1/susannar/kesa2024/score_df_transformed_f30.RData"
