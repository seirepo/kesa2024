...
ggsave(file.path(target_dir, "importances_dataset_uvb_so2_filtered.png"), plot = p1)
ggsave(file.path(target_dir, "importances_dataset_uvb_filtered.png"), plot = p2)
ggsave(file.path(target_dir, "importances_dataset.png"), plot = p3)
